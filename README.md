...
情報系学部の学生です。学内のサーバ管理団体でインフラ運用に携わりながら、個人でもソフトウェア開発に取り組んでいます。仮想化基盤・ネットワーク・監視まわりを中心に、運用で出会った課題を手を動かして深掘りするのが好きです。
...
- 仮想化基盤・物理サーバ・監視の運用
- ツール開発・運用自動化
- セルフホスト環境の構築・検証（自宅サーバでの実験も）
- 競技プログラミング（AtCoder）

### 🔗 Links

[![Zenn](https://img.shields.io/badge/Zenn-3EA8FF?style=flat-square&logo=zenn&logoColor=white)](https://zenn.dev/yuito2742)
